...
contract('MyContract', async (accounts) => {
  ...
  it("should mint tokens to a non owner account.", async () => {
    ...
    let balanceAfter = await smartValorToken.balanceOf.call(accountOne);
